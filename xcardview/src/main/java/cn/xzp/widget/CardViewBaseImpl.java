...
import cn.xzp.widget.RoundRectDrawableWithShadow.RoundRectHelper;
...
class CardViewBaseImpl implements CardViewImpl {
    ...
    public void initialize(CardViewDelegate cardView, Context context, ColorStateList backgroundColor, float radius, float elevation, float maxElevation,
        ...
        RoundRectDrawableWithShadow background = this.createBackground(context, backgroundColor, radius, elevation, maxElevation, shadowColorStart, shadowColorEnd, mTopDelta);
    ...
    private RoundRectDrawableWithShadow createBackground(Context context, ColorStateList backgroundColor, float radius, float elevation, float maxElevation,
                                                         ColorStateList shadowColorStart, ColorStateList shadowColorEnd,float mTopDelta) {
        return new RoundRectDrawableWithShadow(context.getResources(), backgroundColor, radius, elevation, maxElevation, shadowColorStart, shadowColorEnd,mTopDelta);
    }
