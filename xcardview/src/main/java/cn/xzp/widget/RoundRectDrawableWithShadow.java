...
//        this.mShadowEndColor = resources.getColor(R.color.cardview_shadow_end_color);
        ...
        if (shadowColorStart == null) {
            this.mShadowStartColor = ColorStateList.valueOf(resources.getColor(R.color.cardview_shadow_start_color));
        } else {
            this.mShadowStartColor = shadowColorStart;
        }
        if (shadowColorEnd == null) {
            this.mShadowEndColor = ColorStateList.valueOf(resources.getColor(R.color.cardview_shadow_end_color));
        } else {
            this.mShadowEndColor = shadowColorEnd;
        }
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        canvas.translate(0.0F, this.mRawShadowSize / 2.0F * mTopDelta);
    ...
    private void buildShadowCorners() {
        ...
        this.mCornerShadowPaint.setShader(new RadialGradient(0.0F, 0.0F, this.mCornerRadius + this.mShadowSize, new int[]{starColor, starColor, endColor}, new float[]{0.0F, startRatio, 1.0F}, TileMode.CLAMP));
        this.mEdgeShadowPaint.setShader(new LinearGradient(0.0F, -this.mCornerRadius + this.mShadowSize, 0.0F, -this.mCornerRadius - this.mShadowSize, new int[]{starColor, starColor, endColor}, new float[]{0.0F, 0.5F, 1.0F}, TileMode.CLAMP));
        this.mEdgeShadowPaint.setAntiAlias(false);
    }
